{{-- Iconos de las categorías del dataset. Uso: @include('parciales.icono', ['nombre' => 'hoja', 'tamano' => 22]) --}}
<svg xmlns="http://www.w3.org/2000/svg" width="{{ $tamano ?? 22 }}" height="{{ $tamano ?? 22 }}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
@switch($nombre ?? 'punto')
    @case('sol')
