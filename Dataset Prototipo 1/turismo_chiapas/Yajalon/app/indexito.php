...
<head>
  ...
  <title>Mapa Turístico de Yajalon</title>
  <link href="css/estilo_interfaz.css" rel="stylesheet" type="text/css"/>
  ...
  <script type="text/javascript">
	...
	function inicio()
	{
      ...
      var centro_chiapas = new google.maps.LatLng(17.3451722,-92.3819497);
	  ...
	  // Líneas para definifir la activación del menú de la izquierda, mapas
	  ...
	  // Líneas para definifir la activación del menú de la izquierda, categorías
	  ...
	  // Líneas para definifir la activación del menú de la izquierda abajo, tuxmapa
	  ...
	  (
	    '<div class="menu_simple" id="id_menu_mapas">'+
          '<ul class="menu_simple">'+
	        /*'<li class="menu_simple"><a class="menu_simple" href="index.htm">Inicio</a></li>'+*/
	        /*'<li class="menu_simple"><a class="menu_vacuo" href="#"> | </a></li>'+
            '<li class="menu_simple" onmouseover="desplegar(&#39id_menu_mapas_locales&#39)" onmouseout="ocultar(&#39id_menu_mapas_locales&#39)"><a class="menu_vacuo" href="#">Mapas locales</a>'+
        	  '<div class="menu_vertical_130" id="id_menu_mapas_locales">'+
                '<ul class="menu_vertical">'+
                  '<li><a class="menu_vertical" href="http://turismo-tuxtla.tuxmapa.com.mx" target="_blank">Tuxtla Gutiérrez</a></li>'+
                '</ul>'+
              '</div>'+ 
	        '</li>'+ */	  
	        /*'<li class="menu_simple"><a class="menu_vacuo" href="#"> | </a></li>'+*/
            /*'<li class="menu_simple" onclick="cargar_ficha_chiapas()" ><a class="menu_simple" href="#">Ficha técnica de Yajalón</a></li>'+*/
            /*'<li class="menu_simple"><a class="menu_vacuo" href="#"> | </a></li>'+
			'<li class="menu_simple" onmouseover="desplegar(&#39id_menu_revistas&#39)" onmouseout="ocultar(&#39id_menu_revistas&#39)"><a class="menu_vacuo" href="#">Revistas</a>'+
        	  '<div class="menu_vertical_130_revistas" id="id_menu_revistas">'+*/
                '<ul class="menu_vertical">'+
                  '<li onclick="cargar_gastronomia()"><a class="menu_vertical" href="#">Preguntas</a></li>'+ 
                '</ul>'+
              '</div>'+
	        '</li>'+	
		  '</ul>'+
	  ...
	  // menú nivel 1 de categorias 
	  var div_categorias = document.createElement('DIV');
	  div_categorias.className = 'option-categories';
          ...
          '<ul class="menu_vertical">'+		    
			'<li onmouseover="desplegar(&#39id_menu_esparcimiento&#39)" onmouseout="ocultar(&#39id_menu_esparcimiento&#39)"><a class="menu_vertical">Esparcimiento</a>'+
              '<div class="menu_vertical_170_nivel_2" id="id_menu_esparcimiento">'+
			    '<a onclick="marcadores_1()" class="menu_vertical" href="#"><p><b>Esparcimiento</b></p></a>'+
                '<ul class="menu_vertical">'+
			...
			'<li onmouseover="desplegar(&#39id_menu_deportivas&#39)" onmouseout="ocultar(&#39id_menu_deportivas&#39)"><a class="menu_vertical">Deportivas</a>'+
              '<div class="menu_vertical_170_nivel_2" id="id_menu_deportivas">'+
                '<a onclick="marcadores_2()" class="menu_vertical" href="#"><p><b>Deportivas</b></p></a>'+		    
                '<ul class="menu_vertical">'+
                 /* '<li onclick="marcadores_c2(11,2)"><a class="menu_vertical" href="#">Alas deltas</a></li>'+
				  ...
				  '<li onclick="marcadores_c2(124,2)"><a class="menu_vertical" href="#">Basquetball</a></li>'+
				  '<li onclick="marcadores_c2(125,2)"><a class="menu_vertical" href="#">Voliball</a></li>'+
			...
			'<li onmouseover="desplegar(&#39id_menu_natural&#39)" onmouseout="ocultar(&#39id_menu_natural&#39)"><a class="menu_vertical">Ambiente Natural</a>'+
		 	  '<div class="menu_vertical_170_nivel_2" id="id_menu_natural">'+
			    '<a onclick="marcadores_3()" class="menu_vertical" href="#"><p><b>Ambiente Natural</b></p></a>'+
                '<ul class="menu_vertical">'+
			...
			'<li onmouseover="desplegar(&#39id_menu_cultural&#39)" onmouseout="ocultar(&#39id_menu_cultural&#39)"><a class="menu_vertical">Hist&oacute;rico Cultural</a>'+
              '<div class="menu_vertical_170_nivel_2" id="id_menu_cultural">'+
			    '<a onclick="marcadores_4()" class="menu_vertical" href="#"><p><b>Patrimonio Hist&oacute;rico Cultural</b></p></a>'+
                '<ul class="menu_vertical">'+
			...
			'<li onmouseover="desplegar(&#39id_menu_eventos&#39)" onmouseout="ocultar(&#39id_menu_eventos&#39)"><a class="menu_vertical">Eventos programados</a>'+
			  '<div class="menu_vertical_170_nivel_2" id="id_menu_eventos">'+
			    '<a onclick="marcadores_6()" class="menu_vertical" href="#"><p><b>Eventos programados</b></p></a>'+
				'<ul class="menu_vertical">'+
                  /* '<li onclick="marcadores_c2(70,6)"><a class="menu_vertical" href="#">Congresos y seminarios</a></li>'+
				  '<li onclick="marcadores_c2(71,6)"><a class="menu_vertical" href="#">Eventos cient&iacute;ficos</a></li>'+
				  '<li onclick="marcadores_c2(72,6)"><a class="menu_vertical" href="#">Eventos culturales</a></li>'+ */
				  '<li onclick="marcadores_c2(73,6)"><a class="menu_vertical" href="#">Eventos deportivos</a></li>'+
				  /* '<li onclick="marcadores_c2(74,6)"><a class="menu_vertical" href="#">Eventos gastron&oacute;micos</a></li>'+
				  '<li onclick="marcadores_c2(75,6)"><a class="menu_vertical" href="#">Fiestas artesanales</a></li>'+
				  '<li onclick="marcadores_c2(76,6)"><a class="menu_vertical" href="#">Ferias industriales</a></li>'+
				  '<li onclick="marcadores_c2(77,6)"><a class="menu_vertical" href="#">Festivales de cine</a></li>'+ */
				  '<li onclick="marcadores_c2(78,6)"><a class="menu_vertical" href="#">Festivales de m&uacute;sica</a></li>'+
				  //'<li onclick="marcadores_c2(79,6)"><a class="menu_vertical" href="#">Festivales de rock</a></li>'+
				  '<li onclick="marcadores_c2(80,6)"><a class="menu_vertical" href="#">Festivales folkl&oacute;ricos</a></li>'+
				  '<li onclick="marcadores_c2(81,6)"><a class="menu_vertical" href="#">Manifestaciones religiosas</a></li>'+
				  /*'<li onclick="marcadores_c2(82,6)"><a class="menu_vertical" href="#">&Oacute;pera, ballet</a></li>'+
				  '<li onclick="marcadores_c2(93,6)"><a class="menu_vertical" href="#">Ferias ganaderas</a></li>'+
				  '<li onclick="marcadores_c2(94,6)"><a class="menu_vertical" href="#"><i>Spring break</i></a></li>'+ */
				  '<li onclick="marcadores_c2(95,6)"><a class="menu_vertical" href="#">Fiesta popular</a></li>'+
                '</ul>'+
              '</div>'+
	        '</li>'+
			...
			'<li onmouseover="desplegar(&#39id_menu_infraestructura&#39)" onmouseout="ocultar(&#39id_menu_infraestructura&#39)"><a class="menu_vertical">Infraestructura</a>'+
              '<div class="menu_vertical_170_nivel_2" id="id_menu_infraestructura">'+
			    '<a onclick="marcadores_7()" class="menu_vertical" href="#"><p><b>Infraestructura</b></p></a>'+
			    '<ul class="menu_vertical">'+
                  //'<li onclick="marcadores_c2(104,7)"><a class="menu_vertical" href="#">Distribuidores viales</a></li>'+
				  '<li onclick="marcadores_c2(105,7)"><a class="menu_vertical">Hospitales</a></li>'+
				  ...
				  '<li onclick="marcadores_c2(126,7)"><a class="menu_vertical" href="#">Hoteles</a></li>'+
				  '<li onclick="marcadores_c2(127,7)"><a class="menu_vertical" href="#">Auditorios</a></li>'+
				  '<li onclick="marcadores_c2(128,7)"><a class="menu_vertical" href="#">Unidad deportiva/estadio</a></li>'+
				  '<li onclick="marcadores_c2(129,7)"><a class="menu_vertical" href="#">Restaurant</a></li>'+
                '</ul>'+
              '</div>'+
	        '</li>'+         	  
		  '</ul>'+
	...
	function marcadores_infraestructura() 
	{
	  if (window.XMLHttpRequest)
      {// code for IE7+, Firefox, Chrome, Opera, Safari
        xmlhttp=new XMLHttpRequest();
      ...
      xmlhttp.open("GET","xml/marcadores_infraestructura.xml",false);
      xmlhttp.send();
      xmlDoc=xmlhttp.responseXML;
	  
	  // tranferir datos del xml de marcadores a variables para el mapa
	  var imagen = 'imagenes/geo_infraestructura.png';
	  var lat, lng;
	  x=xmlDoc.getElementsByTagName("marcador");
      for(i=0;i<x.length;i++)
      {
	    ...
	    var location = new google.maps.LatLng(lat, lng);
        marker = new google.maps.Marker( {position:location, map:map, icon:imagen, title:nombre } );
		infoMarkers_infraestructura(marker, id);
        markersArray.push(marker);
	  }
    }

	function marcadores_1() 
	{
	  borrar_mapa();
	...
	function marcadores_c2_6(c2,icono) 
	{
	  ...
	  marcadores_c2_6_infraestructura(c2,icono);
	}
	...
	function marcadores_c2_6_infraestructura(c2,icono) 
	{
		borrar_mapa();
	  // átomos permanentes
	  if (window.XMLHttpRequest)
      ...
      xmlhttp.open("GET","php/genera_xml_marcadores_c2_6_3.php?q="+c2,false);
      xmlhttp.send();
      xmlDoc=xmlhttp.responseXML;
	...
	function checkStatus(){
		...
		if(flag==1){
			var x;
		    if (confirm("Desea realizar una encuesta de la pagina?") == true) {
		      	cargar_gastronomia();
		      	flag=0;  
		    } 
		    else {
	...
	function infoMarkers_temporal(markers, address)
    {
      google.maps.event.addListener(markers, 'click', function() 
	  {
	   ...
	   function infoMarkers_infraestructura(markers, address)
    {
      google.maps.event.addListener(markers, 'click', function() 
	  {
	  //  $.fancybox.open({href : 'infraestructura/at'+address+'.html', type : 'iframe'});
	  });
    }

	function cargar_gastronomia()
    {
      $.fancybox.open({href : 'gastronomia.htm', type : 'iframe'});
    }
	
	function cargar_personajes()
    {
      $.fancybox.open({href : 'ficha_personajes.htm', type : 'iframe'});
    }
	function cargar_guia()
    {
      $.fancybox.open({href : 'ficha_guia.html', type : 'iframe'});  
    }

	function cargar_ficha_tuxmapa()
    {
      $.fancybox.open({href : 'ficha_yajalon.html', type : 'iframe'}); 
	...
	function control_personalizado_mapas(controlDiv, map)  
    {
      ...
      controlUI.title = 'Click para ver las preguntas';
      ...
      google.maps.event.addDomListener(controlUI, 'click', function() {cargar_gastronomia()});
    ...
    {
      controlDiv.style.padding = '5px'; // distancia del control con relación al borde del mapa
      controlDiv.className = 'control-div-categories'

       $('.icon-menu').on('click',function(){
      	// $('#id_menu_categorias').css('left','-15rem');
      	$('.control-div-categories').toggleClass('slide');
      	$('.option-categories').toggleClass('slide');
      });

      // Set CSS for the control border
      var controlUI = document.createElement('DIV');
      controlUI.className = 'control-ui-categories'
      controlUI.style.backgroundColor = 'white';
      controlUI.style.borderStyle = 'solid';
      controlUI.style.borderWidth = '2px';
      //controlUI.style.cursor = 'pointer';
      ...
      google.maps.event.addDomListener(controlUI, 'click', 
        ...
        function colocar_marcador_permanente(){
    	var data = document.getElementById('id_permanente').value;

    	borrar_mapa();

    	archivo="xml_individual/"+data+".xml";
    ...
    function colocar_marcador_temporal(){
    	var data = document.getElementById('id_temporal').value;
    ...
    function colocar_marcador_infraestructura(){
    	var data = document.getElementById('id_infraestructura').value;

    	borrar_mapa();

    	archivo="xml_individual/"+data+".xml";

    	var imagen = 'imagenes/geo1.png';
	  	var lat, lng;
    ...
    {
      controlDiv.style.padding = '5px'; // distancia del control con relación al borde del mapa
      controlDiv.className = 'footer';

      // Set CSS for the control border
      var controlUI = document.createElement('DIV');
      controlUI.className = 'footer-text';
      controlUI.style.backgroundColor = 'white';
      controlUI.style.borderStyle = 'solid';
      controlUI.style.borderWidth = '2px';
      controlUI.style.cursor = 'pointer';
      controlUI.style.textAlign = 'center';
      controlUI.title = 'Click para ver descripción de Yajalón';
      controlDiv.appendChild(controlUI);
      ...
      controlText.style.paddingLeft = '4px';
      controlText.style.paddingRight = '4px';
      controlText.innerHTML = 'Mapa Turístico de Yajalón';
      controlUI.appendChild(controlText);
...
<body onload="inicio()" ng-app="">
 <div id="mapa" style="width:100%; height:100%"></div>
 <div class="menu" ng-click="slide = !slide" ng-class="{slide: slide}">
 	<span class="icon-menu"></span>
 </div>



 <div class="option-select" ng-class="{active: activehome - activelocations - activeoffice}"> 	
 	<ul class="option-menu">
 		<li class="option-item hide" ng-hide="!activelocations && !activeoffice"></li>
 		<li class="option-item color3" ng-show="!activelocations && !activeoffice" ng-click="activehome = !activehome"><span class="icon-library"></span></li>

 		<li class="option-item hide" ng-hide="!activehome && !activeoffice"></li>
 		<li class="option-item color2" ng-show="!activehome && !activeoffice" ng-click="activelocations = !activelocations"><span class="icon-location"></span></li>
 		
 		<li class="option-item color1" ng-show="!activehome && !activelocations" ng-click="activeoffice = !activeoffice"><span class="icon-office"></span></li>
 	</ul> 	
 </div>
 <div class="selects home" ng-class="{active: activehome}">
 	<p>Selecciona un sitio permanente:</p>
	<select id="id" onchange="colocar_marcador_permanente()">
		<option value="13">Agua Clara</option>
		<option value="17">Agua Fria</option>
		<option value="23">Auditorio Municipal</option>
		<option value="15">Balneario Loma Bonita</option>
		<option value="14">Campo Loma Bonita</option>
		<option value="05">Cascada Joloniel</option>
		<option value="12">Cascadas de Agua Azul</option>
		<option value="32">Cueva Jolja</option>
		<option value="10">Cuevas de Salto de Agua</option>
		<option value="16">Futbol Rapido</option>
		<option value="06">La Preciosa</option>
		<option value="20">Los Tibios</option>
		<option value="03">Lumilja "Los Patos"</option>
		<option value="34">Manantial el Ocot</option>
		<option value="21">Museo Clemencia Pérez Cruz</option>
		<option value="22">Museo Sellschopp</option>
		<option value="07">Nuevo Limar</option>
		<option value="25">Parque Central</option>
		<option value="19">Parque Infantil</option>
		<option value="08">Parque de Limar</option>
		<option value="24">Parroquia Santiago Apostol</option>
		<option value="09">Poza Azul</option>
		<option value="02">Puente Hidalgo</option>
		<option value="01">Pulpitillo</option>
		<option value="04">Rio Grande</option>
		<option value="33">Takiukum</option>
		<option value="18">Unidad Deportiva</option>		
		<option value="11"> Xanil</option>
		
		
	  </select>
 </div>
 <div class="selects locations" ng-class="{active: activelocations}">
	<p>Selecciona un sitio temporal:</p>
	<select id="id_temporal" onchange="colocar_marcador_temporal()">
		<option value="28">Celebración de la Virgen de Guadalupe</option>
		<option value="26">Fiesta Patronal de Santiago Apostol</option>
		<option value="27">Fiesta en honor a la Virgen del Rosario</option>	
	
	</select>

</div>
<div class="selects office" ng-class="{active: activeoffice}">
	<p>Selecciona un sitio:</p>
	<select id="id_infraestructura" onchange="colocar_marcador_infraestructura()">

		<option value="51">Banamex</option>
		<option value="52">Bancomer</option>
		<option value="41">Barba Roja</option>
		<option value="44">Biblioteca Pública</option>
		<option value="42">Campestre</option>
		<option value="31">Centro de Salud</option>
		<option value="40">El Rincón del Sabor</option>
		<option value="30">Hospital</option>
		<option value="35">Hospital General</option>
		<option value="38">Los Comelones</option>
		<option value="49">Mercado Público</option>
		<option value="45">Ministerio Público</option>
		<option value="37">Monte Libano</option>
		<option value="39">Pizzeria Burguer World</option>
		<option value="43">Presidencia Municipal</option>
		<option value="36">Ram-Mart</option>
		<option value="48">Sitio De Taxis</option>	
		<option value="46">Sitio de Taxis Central</option>
		<option value="47">Sitio de Taxis Central 2</option>
