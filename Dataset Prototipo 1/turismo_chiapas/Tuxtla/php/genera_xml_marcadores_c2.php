<?php
  $con = mysql_connect("localhost","turismotuxtlacre","crespo2772");
  if (!$con) die('!!! Conexión fallida !!!: ' . mysql_error());
  
  mysql_select_db("turismotuxtla", $con);
 ...
 // exit;
  ...
  if ($b==0)  /* no hubo resultados */
  {
	...
	$newnodo -> setAttribute("nombre", "No existen sitios en esta categoria");   // no debe llevar acentos en el servidor
