<?php
  $con = mysql_connect("localhost","hgcrespo_crespo","crespo2772#");
  if (!$con) die('!!! Conexión fallida !!!: ' . mysql_error());
  
  mysql_select_db("hgcrespo_turismo", $con);
  ...
  //$sql = "select * from ATOMOS_TUXTLA_GUTIERREZ where ATG_C2 like '2'";
   $sql = "select * from atomos_tuxtla_gutierrez"; /* en web las minusculas/mayusculas importan*/
